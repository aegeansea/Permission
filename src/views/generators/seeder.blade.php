...
class AbleSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $this->truncateAbleTables();
        
        $config = config('able_seeder.role_structure');
        $userPermission = config('able_seeder.permission_structure');
        $mapPermission = collect(config('able_seeder.permissions_map'));
